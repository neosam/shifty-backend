...
pub fn add_i18n_de(i18n: &mut I18n<Key, Locale>) {
    ...
    i18n.add_text(Locale::De, Key::HoursShort, "Std");
    ...
    i18n.add_text(Locale::De, Key::EditExtraHourLabel, "Bearbeiten");
    i18n.add_text(
        Locale::De,
        Key::ExtraHoursConflictNotice,
        "Eintrag wurde inzwischen geändert. Die Daten wurden aktualisiert. Bitte erneut versuchen.",
    );
    ...
    i18n.add_text(Locale::De, Key::ErrorBannerDismiss, "Fehler schließen");
    ...
    i18n.add_text(Locale::De, Key::AbsenceOneWeek, "1 Woche");
    i18n.add_text(
        Locale::De,
    ...
    i18n.add_text(Locale::De, Key::AbsenceEditHoursAction, "Stunden bearbeiten");
    i18n.add_text(
        Locale::De,
    ...
    // Phase 20 Plan 01 — UV-03: ⚠️-Indikator-Tooltip.
    i18n.add_text(
        Locale::De,
        Key::AbsenceHourlyWarnIndicator,
        "Noch nicht in einen Zeitraum umgewandelt — bitte konvertieren",
    );
    ...
    i18n.add_text(Locale::De, Key::BookingWarningDismiss, "Hinweis schließen");
    i18n.add_text(
        Locale::De,
    ...
    i18n.add_text(Locale::De, Key::ImpersonateActAs, "🥸 Agieren");
