# Requirements Archive: v1.10 Feiertage — UI-Pflege & Schichtplan-Soll-Konsistenz
...
- **Snapshot-Schema-Version-Bump:** verifiziert **nicht** nötig — `billing_period`-
  Snapshots speisen sich aus dem `reporting.rs`-`holiday_hours`-Pfad, nicht aus
  `get_week`/`booking_information`. In der HSP-Phase bestätigt (kein Bump, bleibt 12).
...
---
*Requirements definiert: 2026-06-30 (v1.10 milestone start).*
*Geshipt + archiviert: 2026-06-30 (12/12 Requirements satisfied, Audit `passed`).*
