...
Provides an `UnpaidLeave` extra hours category for tracking unpaid leave as an absence that reduces expected hours without consuming vacation entitlement.
