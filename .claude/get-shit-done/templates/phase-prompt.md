...
<!-- For checkpoint task examples and patterns, see @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/checkpoints.md -->
...
See `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
