...
```
Task(
  prompt="Read /home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/templates/VALIDATION.md`
