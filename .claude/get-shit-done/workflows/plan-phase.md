...
@/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/ui-brand.md
@/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/revision-loop.md
@/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/gate-prompts.md
...
**If found:**
1. Read template: `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/templates/VALIDATION.md`
...
${TDD_MODE === 'true' ? `
<tdd_mode_active>
**TDD Mode is ENABLED.** Apply TDD heuristics from @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/tdd.md to all eligible tasks:
...
if [ "$POST_PLANNING_GAPS" = "true" ]; then
  node "/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/bin/gsd-tools.cjs" gap-analysis --phase-dir "${PHASE_DIR}"
fi
```
