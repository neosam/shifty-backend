...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/.gsd-surface.json`
(sibling to `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/skills`).
...
`/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/.gsd-surface.json`
Install profile marker: `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/.gsd-profile`
Skill dirs: `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/skills/gsd-*/`
Engine module: `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
