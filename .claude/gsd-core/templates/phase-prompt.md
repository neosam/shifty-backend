...
<!-- For checkpoint task examples and patterns, see @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
