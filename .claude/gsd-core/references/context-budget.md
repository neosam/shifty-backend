...
The keys live in `.claude/settings.json` (project) or `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/settings.json` (global) — **not** in `.planning/config.json`:
