...
<template>
@/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/workflows/transition.md`.
...
- Follow @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/workflows/diagnose-issues.md
