...
ones). Reference: @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / /home/neosam/programming/rust/projects/shifty/shifty-backend/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/templates/spec.md.
