...
<required_reading>
@/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/references/ai-frameworks.md
@/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
Copy template:
```bash
cp "/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
