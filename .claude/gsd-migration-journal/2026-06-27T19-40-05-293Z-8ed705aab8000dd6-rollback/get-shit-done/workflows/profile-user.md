...
Key references:
- @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/USER-PROFILE.md" "/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/CLAUDE.md
```
