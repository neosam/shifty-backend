...
```bash
INIT=$(node "/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
