...
<reference>
@/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/user-profiling.md` to load:
