...
**Verification depth scales with `asvs_level`** (see @/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
