...
<required_reading>
Read `/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/ai-evals.md` — specifically the rubric design and domain expert sections.
</required_reading>
