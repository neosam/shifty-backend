...
@/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "/home/neosam/programming/rust/projects/shifty/shifty-backend/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
